 ...
 * This file demonstrates how to integrate Vaultiris with a web frontend
 */

// For React/Vue/Angular applications
export class VaultirisClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new VaultirisClient(provider, contractAddress);
